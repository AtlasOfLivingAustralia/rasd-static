...
###
# Deploy the codepipeline for RASD backups
...
aws cloudformation deploy \
    ...
    --parameter-overrides \
        ...
        pExporterGitHubBranch=$EXPORTER_GITHUB_BRANCH \
        pExporterGitHubOwner=$EXPORTER_GITHUB_OWNER \
        pExporterGitHubRepositoryName=$EXPORTER_GITHUB_REPO_NAME \
