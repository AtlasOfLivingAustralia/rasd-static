...
Metadata statements need to conform to the standards set out in the best practice metadata sample available in [Supplement 4](supplements.html): Restricted Access Species Data Metadata Statement Template and row level metadata to conform to Darwin Core.
