...
It is best practice to work towards transforming RASD that is exposed publicly following the process in [Supplement 6](supplements.html). This ensures that data are transformed consistently, and the users understand how the data they are using has been transformed.
