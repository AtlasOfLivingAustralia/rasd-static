...
It is best practice to follow the CARE principles when dealing with Indigenous data or knowledge (see [Supplement 1](supplement1.qmd))
...
Consistent with the Australian Government's Best Practice Guide to Applying Data Sharing Principles, this framework encourages data custodians to make best efforts to work towards minimising the practice of withholding datasets and information on this is available in [Supplement 7](supplement7.qmd): Withheld Data and Restricted Access Species Data. Recognising that some datasets need to be withheld, data custodians are encouraged to provide metadata on withheld datasets to provide transparency on what datasets exist nationally.
