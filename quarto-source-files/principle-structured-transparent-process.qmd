...
![](images/RASD-fig-3-data-request-process.png){fig-alt="Flowchart showing the data access request process, through to if the request is approved or denied" width="91"}
